 ...
 * @addtogroup Skins
 */
class SkinKN extends SkinTemplate {
	/** Using kn. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'kn';
		$this->stylename = 'kn';
		$this->template  = 'KNTemplate';
	}
}
 ...
 * @addtogroup Skins
 */
class KNTemplate extends QuickTemplate {
	/**
	 * Template filter callback for KN skin.
...
<?php		}
		...
		wfRunHooks( 'KNTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
